                    ...
                    <div className="journey-inner-con">
                        <div className="journey-text-con">
                            <div className=" text-left ">
                                <h3 data-aos="fade-up" data-aos-duration="700" className="font-weight-bold mb-4">Why You Should Join Our Event? </h3>
                                <p className="" data-aos="fade-up" data-aos-duration="700">Attending our event not only gives you the opportunity to meet experts in the field but also gives exposure to new ideas that could be implemented in your own business.</p>
                            </div>
                            <div className="row">
                                <div className="col-6">
                        ...
                        <div className="journey-video-con d-inline-block">
                            <div className="video-inner-con">
                                <div className="learning-conference-video-box" data-aos="fade-up" data-aos-duration="700">

    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <p class="font-weight-bold generic-btn text-center">
                ...
                <p>Exhibition:</p>
                <p>Exhibition Time: 09:00-17:00, on all conference days</p>
            </div> 
            <div className="col-lg-12 text-center">
                <h3>Other Sponsorship Packages:</h3>
            </div>
            <div className="col-lg-12">
                <p>Conference Bag: $6000</p>
                <ul>
            ...
            <div className="col-lg-12 generic-btn text-center">

              ...
              <div className='container'>
                  ...
                  <div className="row">
                    <div className="col-lg-12">
                      ...
                      <p>The Organizer cannot refund or pay any compensation where could not attend the conference is prevented by reason of circumstances which amount to “personal reason”. Such as travel difficulties, visa problems, health issues, financial default etc.</p>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-lg-12">
